...
public function  get_swfAsset() : SwfAsset
      ...
      {
         if(mPetPortrait != null && mPetPortrait.petNPCGameObject == param1)
         {
      ...
      public function initializeHud(param1:HeroGameObjectOwner) 
      {
         ...
         if(mAssetsLoaded && mHeroOwner != null)
         {
            ...
            busterName = busterAttack != null ? busterAttack.Name : "BUSTER!";
      ...
      function setupModifiers(param1:UIButton, param2:DungeonModifierHelper) 
      {
         ...
         ASCompat.setProperty((dungeonModButton.tooltip : ASAny).title_label, "text", gmDungeonModifier.GMDungeonMod.Name);
         ASCompat.setProperty((dungeonModButton.tooltip : ASAny).description_label, "text", gmDungeonModifier.GMDungeonMod.Description);
      ...
      function setupConsumableWeaponUI(param1:Vector<ConsumableWeaponGameObject>) 
      {
         ...
         while(i < (equippedConsumableWeapons.length : UInt))
         {
            ...
            if(equippedConsumableWeapons[(i : Int)] != null)
            {
               ...
               ASCompat.setProperty((button.tooltip : ASAny).description_label, "text", consumableWeaponGameObject.getGMStackable().Description);
               tooltip.visible = true;
...
public function  get_floaterTextClass() : Dynamic
      ...
      public function destroy() 
      {
         ...
         final __ax4_iter_107 = mWeaponButtons;
         if (checkNullIteratee(__ax4_iter_107)) for (_tmp_ in __ax4_iter_107)
         {
            _loc1_  = _tmp_;
            if(_loc1_ != null)
            {
         ...
         final __ax4_iter_108 = mConsumableWeaponButtons;
         if (checkNullIteratee(__ax4_iter_108)) for (_tmp_ in __ax4_iter_108)
         {
            _loc1_  = _tmp_;
            if(_loc1_ != null)
            {
...
public function  get_offScreenPlayerManager() : UIOffScreenPlayerManager
      ...
      {
         var _loc2_:UIButton;
         final __ax4_iter_109 = mWeaponButtons;
         if (checkNullIteratee(__ax4_iter_109)) for (_tmp_ in __ax4_iter_109)
         {
            _loc2_ = _tmp_;
            ASCompat.setProperty((_loc2_.root : ASAny).selectionFrame, "visible", false);
         }
...
public function  get_crowdDestination() : Vector3D
      ...
      public function showBuffDisplay(param1:BuffGameObject) 
      {
         ...
         mAssetLoadingComponent.getSwfAsset(DBFacade.buildFullDownloadPath(buffGO.buffData.IconSwf),function(param1:SwfAsset)
         {
            ...
            ASCompat.setProperty((_loc4_ : ASAny).tooltip.title_label, "text", buffGO.buffData.Name);
            ASCompat.setProperty((_loc4_ : ASAny).tooltip.description_label, "text", buffGO.buffData.Description + buffGO.buffData.getStacksDescription((buffGO.instanceCount : Int)));
      ...
      public function updateBuffInstance(param1:BuffGameObject) 
      {
         ...
         while(_loc3_ < mBuffs.length)
         {
            ...
            if(_loc2_ == param1)
            {
               ...
               ASCompat.setProperty((mBuffIconButtons[_loc3_].root : ASAny).tooltip.description_label, "text", _loc2_.buffData.Description + _loc2_.buffData.getStacksDescription((_loc2_.instanceCount : Int)));
