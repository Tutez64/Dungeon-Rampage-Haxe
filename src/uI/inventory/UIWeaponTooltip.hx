    ...
    class UIWeaponTooltip extends MovieClip
   {
      ...
      public function setWeaponItemFromWeaponGameObject(param1:WeaponGameObject) 
      {
         ...
         if(param1.legendaryModifier != null)
         {
            ...
            mNameLabel.text = param1.weaponData.getWeaponAesthetic((0 : UInt),true).Name;
         }
      ...
      public function setWeaponItemFromItemInfo(param1:ItemInfo) 
      {
         ...
         if(param1.legendaryModifier != 0)
         {
            ...
            mNameLabel.text = param1.gmWeaponItem.getWeaponAesthetic((0 : UInt),true).Name;
         }
         mNameLabel.text = mNameLabel.text.toUpperCase();
      }
      
      public function setWeaponItemFromData(param1:String, param2:UInt, param3:String, param4:String, param5:UInt, param6:UInt, param7:UInt, param8:UInt, param9:UInt) 
      {
         var _loc10_= 0;
         clearAllIcons();
         mNameLabel.text = param1.toUpperCase();
         var _loc14_= ASCompat.dynamicAs(mDBFacade.gameMaster.rarityById.itemFor(param8), gameMasterDictionary.GMRarity);
         var _loc11_= (ASCompat.toInt(_loc14_ != null && _loc14_.TextColor != 0 ? _loc14_.TextColor : 15463921) : UInt);
         ...
         var _loc13_= "";
         var _loc12_= new Vector<GMModifier>();
         if(param5 > 0)
         {
            _loc12_.push(ASCompat.dynamicAs(mDBFacade.gameMaster.modifiersById.itemFor(param5), gameMasterDictionary.GMModifier));
         }
         if(param6 > 0)
         {
            _loc12_.push(ASCompat.dynamicAs(mDBFacade.gameMaster.modifiersById.itemFor(param6), gameMasterDictionary.GMModifier));
         }
         _loc10_ = 0;
         while(_loc10_ < _loc12_.length)
         {
            mModifiersList.push(new UIModifier(mDBFacade,ASCompat.reinterpretAs(mRoot.getChildByName("modifier_icon_" + Std.string((_loc10_ + 1))) , MovieClip),_loc12_[_loc10_].Constant));
