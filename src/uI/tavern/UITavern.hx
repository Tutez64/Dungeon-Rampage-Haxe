...
;
    ...
    class UITavern
   {
      ...
      public function new(param1:DBFacade, param2:MovieClip, param3:TownHeader)
      {
         ...
         mLogicalWorkComponent = new LogicalWorkComponent(param1,"UITavern");
      ...
      function loadTavernInfo() 
      {
         ...
         mAssetLoadingComponent.getSwfAsset(DBFacade.buildFullDownloadPath("Resources/Art2D/UI/db_UI_town.swf"),function(param1:brain.assetRepository.SwfAsset)
         {
            ...
            if (checkNullIteratee(__ax4_iter_206)) for (_tmp_ in __ax4_iter_206)
            {
               _loc4_  = _tmp_;
               ASCompat.setProperty(_loc4_, "tooltip", ASCompat.createInstance(_loc2_, []));
               ASCompat.setProperty(_loc4_, "tooltipPos", new Point(0,0));
      ...
      function loadHeroOffers() 
      {
         ...
         if (checkNullIteratee(__ax4_iter_207)) for (_tmp_ in __ax4_iter_207)
         {
            _loc4_ = _tmp_;
      ...
      function populateAvatarInfo(param1:Int) 
      {
         ...
         ASCompat.setProperty((mTavernInfoClip : ASAny).avatar_name_text, "text", GameMasterLocale.getGameMasterSubString("SKIN_NAME",_loc3_.Constant).toUpperCase());
      ...
      function skinSelected(param1:GMSkin) 
      {
         ...
         if(param1 != null)
         {
            ASCompat.setProperty((mStoryInfoClip : ASAny).avatar_description_text, "text", GameMasterLocale.getGameMasterSubString("SKIN_DESCRIPTION",param1.Constant));
            ASCompat.setProperty((mStoryInfoClip : ASAny).avatar_likes_text, "text", GameMasterLocale.getGameMasterSubString("SKIN_LIKES",param1.Constant).toUpperCase());
            ASCompat.setProperty((mStoryInfoClip : ASAny).avatar_dislikes_text, "text", GameMasterLocale.getGameMasterSubString("SKIN_DISLIKES",param1.Constant).toUpperCase());
            ASCompat.setProperty((mStoryInfoClip : ASAny).avatar_nickname_text, "text", GameMasterLocale.getGameMasterSubString("SKIN_NICKNAME",param1.Constant).toUpperCase());
         }
      ...
      public function populateWeaponIcons(param1:Int) 
      {
         ...
         var weaponIconCallback:ASFunction = function(param1:Int, param2:GMWeaponMastertype):ASFunction
         {
            ...
            return function(param1:brain.assetRepository.SwfAsset)
            {
               ...
               ASCompat.setProperty((mWeaponIconsVector[index].tooltip : ASAny).title_label, "text", GameMasterLocale.getGameMasterSubString("WEAPON_MASTERTYPE",subType.Constant).toUpperCase());
            };
         };
