...
;
    ...
    class DBUIPopup extends UIObject
   {
      ...
      public function new(param1:DBFacade, param2:String = "", param3:ASAny = null, param4:Bool = true, param5:Bool = true, param6:ASFunction = null, param7:Bool = false, param8:Bool = true)
      {
         var dbFacade= param1;
         mDBFacade = dbFacade;
