...
;
    ...
    class UIStacksHud
   {
      ...
      function createStacks() 
      {
         ...
         final __ax4_iter_104 = mStacksUI;
      ...
      function setupBooster(param1:BoosterInfo, param2:UInt) 
      {
         ...
         if(boosterInfo != null)
         {
            ...
            ASCompat.setProperty((xpStack.tooltip : ASAny).title_label, "text", boosterInfo.StackInfo.Name.toUpperCase());
      ...
      {
         var __ax4_iter_105:Vector<UIObject>;
         var __ax4_iter_106:Vector<CountdownTextTimer>;
         var _loc2_:UIObject = null;
         var _loc1_:CountdownTextTimer = null;
         if(mStacksUI != null)
         {
            __ax4_iter_105 = mStacksUI;
         ...
         {
            __ax4_iter_106 = mStackTimersUI;
            if (checkNullIteratee(__ax4_iter_106)) for (_tmp_ in __ax4_iter_106)
            {
               _loc1_  = _tmp_;
               if(_loc1_ != null)
               {
