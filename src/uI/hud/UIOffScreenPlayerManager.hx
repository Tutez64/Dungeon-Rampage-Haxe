...
;
    ...
    class UIOffScreenPlayerManager
   {
      ...
      function updatePosition(param1:ActorGameObject) 
      {
         ...
         {
            _loc7_ = ASCompat.dynamicAs(mOffScreenPlayerMap.itemFor(param1.id), uI.hud.UIOffScreenClip);
      ...
      {
         var _loc2_= ASCompat.dynamicAs(mOffScreenPlayerMap.itemFor(param1), uI.hud.UIOffScreenClip);
         if(_loc2_ != null)
         {
      ...
      public function handlePicChange(param1:Int, param2:String) 
      {
         ...
         {
            _loc3_ = ASCompat.dynamicAs(mOffScreenPlayerMap.itemFor(param1), uI.hud.UIOffScreenClip);
            if(_loc3_ == null)
            {
               return;
            }
