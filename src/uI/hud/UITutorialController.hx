...
class UITutorialController {
	...
	public function queueTutorial(type:String) {
		if (ASCompat.toBool(mTutorialEventMap.itemFor(type))) {
			return;
		}
		switch (type) {
