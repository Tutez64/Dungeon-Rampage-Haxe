...
class UIExitPopup extends DBUITwoButtonPopup {
	...
	public function new(dbFacade:DBFacade) {
		...
		var _loc7_ = dbFacade.dbConfigManager.getConfigBoolean("show_wishlist_on_exit_popup", false);
		if (_loc7_) {
		...
		super(dbFacade, _loc4_, _loc6_, _loc2_, _loc5_, _loc8_, _loc3_, true, closePopupAction, true, true, "EXIT_POPUP");
	}
