    ...
    class UIVictoryBoosterPopup extends DBUIPopup
   {
      ...
      function setupStackIcons(param1:SwfAsset) 
      {
         ...
         if(expStack != null)
         {
            ...
            ASCompat.setProperty((mExpObject.tooltip : ASAny).title_label, "text", GameMasterLocale.getGameMasterSubString("STACKABLE_NAME",expStack.Constant).toUpperCase());
            ASCompat.setProperty((mExpObject.tooltip : ASAny).description_label, "text", GameMasterLocale.getGameMasterSubString("STACKABLE_DESCRIPTION",expStack.Constant));
            mPopup.visible = true;
         ...
         if(goldStack != null)
         {
            ...
            ASCompat.setProperty((mGoldObject.tooltip : ASAny).title_label, "text", GameMasterLocale.getGameMasterSubString("STACKABLE_NAME",goldStack.Constant).toUpperCase());
            ASCompat.setProperty((mGoldObject.tooltip : ASAny).description_label, "text", GameMasterLocale.getGameMasterSubString("STACKABLE_DESCRIPTION",goldStack.Constant));
            mPopup.visible = true;
