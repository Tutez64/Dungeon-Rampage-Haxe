...
;
    ...
    class DBUIOneButtonPopup extends DBUIPopup
   {
      ...
      public function new(param1:DBFacade, param2:String, param3:ASAny, param4:String, param5:ASFunction, param6:Bool = true, param7:ASFunction = null, param8:String = null, param9:String = null)
      {
