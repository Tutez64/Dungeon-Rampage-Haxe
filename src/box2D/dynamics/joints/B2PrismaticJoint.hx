...
/*use*/ /*namespace*/ /*b2internal*/ class B2PrismaticJoint extends B2Joint {
	/*b2internal*/
	...
	override public function SolveVelocityConstraints(step:B2TimeStep) {
		...
		if (this.m_enableMotor && this.m_limitState != B2Joint.e_equalLimits) {
			...
			_loc17_ = step.dt * this.m_maxMotorForce;
	...
	override public function SolvePositionConstraints(baumgarte:Float):Bool {
		...
		_loc6_.x -= m_invMassA * _loc31_;
		_loc6_.y -= m_invMassA * _loc32_;
		_loc7_ -= m_invIA * _loc33_;
		_loc8_.x += m_invMassB * _loc31_;
		_loc8_.y += m_invMassB * _loc32_;
		_loc9_ += m_invIB * _loc34_;
