...
;
    ...
    class B2PrismaticJoint extends B2Joint
   {
      ...
      public function new(param1:B2PrismaticJointDef)
      {
      ...
      override public function InitVelocityConstraints(param1:B2TimeStep) 
      {
         ...
         if(this.m_motorMass > ASCompat.MIN_FLOAT)
         {
      ...
      override public function SolveVelocityConstraints(param1:B2TimeStep) 
      {
         ...
         if(this.m_enableMotor && this.m_limitState != /*b2internal::*/B2Joint.e_equalLimits)
         {
            ...
            _loc15_ = this.m_motorImpulse - _loc16_;
            _loc8_ = _loc15_ * this.m_axis.x;
      ...
      override public function SolvePositionConstraints(param1:Float) : Bool
      {
         ...
         var _loc28_= new B2Vec3();
         var _loc29_= this.m_perp.x * _loc26_ + this.m_perp.y * _loc27_;
         var _loc30_= _loc9_ - _loc7_ - this.m_refAngle;
         ...
         var _loc31_= _loc28_.x * this.m_perp.x + _loc28_.z * this.m_axis.x;
         var _loc32_= _loc28_.x * this.m_perp.y + _loc28_.z * this.m_axis.y;
         var _loc33_= _loc28_.x * this.m_s1 + _loc28_.y + _loc28_.z * this.m_a1;
         var _loc34_= _loc28_.x * this.m_s2 + _loc28_.y + _loc28_.z * this.m_a2;
