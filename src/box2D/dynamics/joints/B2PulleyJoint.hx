...
/*use*/ /*namespace*/ /*b2internal*/ class B2PulleyJoint extends B2Joint {
	/*b2internal*/
	public static inline final b2_minPulleyLength:Float = 2;
	...
	var m_u1:B2Vec2 = new B2Vec2();

	var m_u2:B2Vec2 = new B2Vec2();
	...
	public function GetGroundAnchorA():B2Vec2 {
		var _loc1_ = this.m_ground.m_xf.position.Copy();
	...
	public function GetLength1():Float {
		var _loc1_ = m_bodyA.GetWorldPoint(this.m_localAnchor1);
		var _loc2_ = this.m_ground.m_xf.position.x + this.m_groundAnchor1.x;
		var _loc3_ = this.m_ground.m_xf.position.y + this.m_groundAnchor1.y;
	...
	public function GetLength2():Float {
		var _loc1_ = m_bodyB.GetWorldPoint(this.m_localAnchor2);
		var _loc2_ = this.m_ground.m_xf.position.x + this.m_groundAnchor2.x;
		var _loc3_ = this.m_ground.m_xf.position.y + this.m_groundAnchor2.y;
		var _loc4_ = _loc1_.x - _loc2_;
		var _loc5_ = _loc1_.y - _loc3_;
		return Math.sqrt(_loc4_ * _loc4_ + _loc5_ * _loc5_);
	}
	...
	override public function InitVelocityConstraints(step:B2TimeStep) {
		...
		var _loc5_ = this.m_localAnchor1.x - _loc2_.m_sweep.localCenter.x;
		...
		_loc8_ = _loc7_;
		var _loc10_ = _loc2_.m_sweep.c.x + _loc5_;
		var _loc11_ = _loc2_.m_sweep.c.y + _loc6_;
		var _loc12_ = _loc3_.m_sweep.c.x + _loc8_;
		var _loc13_ = _loc3_.m_sweep.c.y + _loc9_;
		var _loc14_ = this.m_ground.m_xf.position.x + this.m_groundAnchor1.x;
		var _loc15_ = this.m_ground.m_xf.position.y + this.m_groundAnchor1.y;
		var _loc16_ = this.m_ground.m_xf.position.x + this.m_groundAnchor2.x;
		var _loc17_ = this.m_ground.m_xf.position.y + this.m_groundAnchor2.y;
	...
	override public function SolveVelocityConstraints(step:B2TimeStep) {
		...
		_loc4_ = _loc2_.m_xf.R;
		var _loc5_ = this.m_localAnchor1.x - _loc2_.m_sweep.localCenter.x;
		var _loc6_ = this.m_localAnchor1.y - _loc2_.m_sweep.localCenter.y;
		var _loc7_ = _loc4_.col1.x * _loc5_ + _loc4_.col2.x * _loc6_;
		_loc6_ = _loc4_.col1.y * _loc5_ + _loc4_.col2.y * _loc6_;
		_loc5_ = _loc7_;
		_loc4_ = _loc3_.m_xf.R;
	...
	override public function SolvePositionConstraints(baumgarte:Float):Bool {
		...
		var _loc2_ = m_bodyA;
		var _loc3_ = m_bodyB;
		var _loc5_ = this.m_ground.m_xf.position.x + this.m_groundAnchor1.x;
		var _loc6_ = this.m_ground.m_xf.position.y + this.m_groundAnchor1.y;
		var _loc7_ = this.m_ground.m_xf.position.x + this.m_groundAnchor2.x;
		var _loc8_ = this.m_ground.m_xf.position.y + this.m_groundAnchor2.y;
		var _loc24_:Float = 0;
		if (this.m_state == B2Joint.e_atUpperLimit) {
			_loc4_ = _loc2_.m_xf.R;
