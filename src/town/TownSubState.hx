...
class TownSubState extends State {
	...
	public function new(dbFacade:DBFacade, townStateMachine:TownStateMachine, stateName:String) {
		super(stateName);
		mDBFacade = dbFacade;
	...
	public function set_rootMovieClip(rootClip:MovieClip):MovieClip {
		mRootMovieClip = rootClip;
