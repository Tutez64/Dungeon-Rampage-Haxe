...
class KeyPanel {
	...
	public function new(dbFacade:DBFacade, assetLoadingComponent:AssetLoadingComponent, buyCallBack:ASFunction, closeCallBack:ASFunction, stateCreated:String) {
		mDBFacade = dbFacade;
		mAssetLoadingComponent = assetLoadingComponent;
		mBuyKeysCallback = buyCallBack;
		mCloseCallBack = closeCallBack;
		mStateCreated = stateCreated;
	...
	function swfLoaded(swfAsset:SwfAsset) {
		var _loc2_ = swfAsset.getClass("header_key_inventory");
