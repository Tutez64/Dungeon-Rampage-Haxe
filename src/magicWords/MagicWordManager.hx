...
class MagicWordManager {
	...
	public function PhpUnlockMapNodes(startNode:Int, endNode:Int = 0) {
	...
	public function PhpGiveGems(numGems:Int) {
	...
	public function PhpGiveCoins(numCoins:Int) {
	...
	public function PhpGiveXp(xpAmount:Int) {
