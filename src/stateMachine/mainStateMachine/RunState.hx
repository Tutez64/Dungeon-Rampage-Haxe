...
class RunState extends State {
	...
	public function new(dbFacade:DBFacade, goToSplashScreenCallback:ASFunction) {
		super("RunState");
		mDBFacade = dbFacade;
		mGoToSplashScreenCallback = goToSplashScreenCallback;
	...
	function receivedClientEvent(lecEvt:LEClientEvent) {
	...
	function gracefulSocketClose(event:ClientExitCompleteEvent) {
