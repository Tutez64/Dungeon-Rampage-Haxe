...
interface IDistributedNPCGameObject {
	function setNetworkComponentDistributedNPCGameObject(iface:DistributedNPCGameObjectNetworkComponent):Void;
	...
	function ReceiveTimelineAction(timelineAction:String):Void;
}
