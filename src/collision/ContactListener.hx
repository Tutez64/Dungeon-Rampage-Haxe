...
class ContactListener extends B2ContactListener {
	...
	override public function BeginContact(contact:B2Contact) {
		...
		var _loc6_ = contact.GetFixtureA();
		var _loc5_ = contact.GetFixtureB();
...
private class CollisionHelper {
	...
	public function new(contactRes:IContactResolver, theActorId:UInt, func:ASFunction) {
		contactResolver = contactRes;
		actorId = theActorId;
