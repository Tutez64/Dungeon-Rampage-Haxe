...
class ChargeEffectGameObject extends EffectGameObject {
	...
	public function new(facade:DBFacade, swfPath:String, className:String, actorView:ActorView) {
		super(facade, swfPath, className, 1);
		mReady = false;
		mLogicalWorkComponent = new LogicalWorkComponent(facade, "ChargeEffectGameObject");
