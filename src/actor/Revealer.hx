...
class Revealer {
	...
	public function new(root:DisplayObject, dbFacade:DBFacade, duration:UInt, finishedCallback:ASFunction = null, revealType:UInt = (0 : UInt)) {
		mDBFacade = dbFacade;
		mRoot = root;
	...
	function update(clock:GameClock) {
		var _loc4_ = Math.NaN;
		var _loc2_ = Math.NaN;
		var _loc3_ = Math.NaN;
