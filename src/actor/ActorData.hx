...
class ActorData {
	...
	public function getSpriteSheetClassName(anim:String):String {
		return mData.AssetClassName + "_" + anim + ".png";
	}
	...
	public function getOffSpriteSheetClassName(anim:String):String {
		return mData.AssetClassName + "_off_" + anim + ".png";
	}
