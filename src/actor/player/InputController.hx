...
class InputController {
	...
	public function new(heroGameObject:HeroGameObjectOwner, dbFacade:DBFacade) {
		mDBFacade = dbFacade;
		...
		mGamepadController = new GamepadController(mDBFacade, mHeroGameObject, dbFacade.steamInputManager);
	...
	public function canMoveR(inputType:String):Bool {
		return inputType != "lock_r" && inputType != "lock_xy_r";
	}

	public function canMoveXY(inputType:String):Bool {
		return inputType != "lock_xy" && inputType != "lock_xy_r" && !mDBFacade.inputManager.check(16);
	}
	...
	public function set_inputType(val:String):String {
		return mInputType = val;
	}
