...
class AssetLoaderInfo {
	...
	public function new(path:String, useCacheIn:Bool) {
		useCache = useCacheIn;
		dependentAssetPath = path;
		if (dependentAssetPath == null
			|| dependentAssetPath == ""
			|| dependentAssetPath == "null"
			|| dependentAssetPath.indexOf("../../../null") != -1) {
