...
/*use*/ /*namespace*/ /*as3commons_collections*/ class AbstractLinkedCollectionIterator implements ICollectionIterator {
	...
	public function start() {
		this._next = ASCompat.dynamicAs(this._collection.size != 0 ? this._collection.firstNode_internal : null,
			org.as3commons.collections.framework.core.LinkedNode);
		this._current = null;
	}
	...
	public function hasPrevious():Bool {
		return this._next != this._collection.firstNode_internal && this._collection.size != 0;
	}
	...
	public function previous():ASAny {
		if (this._next == this._collection.firstNode_internal || this._collection.size == 0) {
			this._current = null;
			return /*undefined*/ null;
		}
