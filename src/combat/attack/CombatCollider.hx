...
class CombatCollider {
	...
	public function new(dbFacade:DBFacade, parentObject:ActorGameObject, box2DWorld:B2World) {
		mDBFacade = dbFacade;
		mParentGameObject = parentObject;
	...
	public function set_position(val:Vector3D):Vector3D {
		mB2Transform.position = NavCollider.convertToB2Vec2(val);
		return val;
	}
